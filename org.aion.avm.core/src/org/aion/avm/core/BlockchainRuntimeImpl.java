...
public class BlockchainRuntimeImpl implements IBlockchainRuntime {
    ...
    public void avm_log(ByteArray data) {
        ...
        Log log = new Log(ctx.getContractAddress().toBytes(), List.of(), data.getUnderlying());
        result.addLog(log);
    }
    ...
    public void avm_log(ByteArray topic1, ByteArray data) {
        ...
        Log log = new Log(ctx.getContractAddress().toBytes(), List.of(HashUtils.sha256(topic1.getUnderlying())), data.getUnderlying());
        result.addLog(log);
    }
    ...
    public void avm_log(ByteArray topic1, ByteArray topic2, ByteArray data) {
        ...
        Log log = new Log(ctx.getContractAddress().toBytes(), List.of(HashUtils.sha256(topic1.getUnderlying()), HashUtils.sha256(topic2.getUnderlying())),
                data.getUnderlying());
        result.addLog(log);
    }

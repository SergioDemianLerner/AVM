...
public class DemoTest {
    ...
    private org.aion.vm.api.interfaces.Address deployer = AvmAddress.wrap(Helpers.randomBytes(Address.LENGTH));
    private org.aion.vm.api.interfaces.Address owner1 = AvmAddress.wrap(Helpers.randomBytes(Address.LENGTH));
    private org.aion.vm.api.interfaces.Address owner2 = AvmAddress.wrap(Helpers.randomBytes(Address.LENGTH));
    private org.aion.vm.api.interfaces.Address receiver = AvmAddress.wrap(Helpers.randomBytes(Address.LENGTH));
